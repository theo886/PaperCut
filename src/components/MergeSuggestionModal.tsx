...
import { MergeSuggestionModalProps, Suggestion } from '../types';

const MergeSuggestionModal: React.FC<MergeSuggestionModalProps> = ({ 
  isOpen, 
  onClose, 
  targetSuggestion, 
  ...
  const handleMerge = (): void => {
    if (!selectedSourceId || !targetSuggestion) return;
